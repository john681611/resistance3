if (isServer) then {
	...
	};
	{
		...
		null = [_x, [_PApatrols, _PAgroupArray], [_LVehGroups, _LVgroupArray], [_AVehGroups], [_CHGroups, _CHgroupArray], _settings, _basSettings] execVM "Server\eos\core\b_core.sqf";
	}forEach _JIPmkr;
};
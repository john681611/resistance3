...
if (!isDedicated) then {};
//FNC
call compile preprocessFile "=BTC=_revive\lite\=BTC=_functions.sqf";
...
[] spawn
{
	...
	player addAction [("<t color=""#ED2744"">") + ("CPR") + "</t>","=BTC=_revive\=BTC=_addAction.sqf",[[],BTC_cpr], 8, true, true, "", "[] call BTC_check_action_drag"];

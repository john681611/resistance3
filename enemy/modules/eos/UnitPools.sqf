...
// EAST CSAT FACTION
	if (_faction==0) then {
	_InfPool=	["O_Soldier_F","O_Soldier_GL_F","O_Soldier_LAT_F","O_medic_F","O_Soldier_AR_F","O_Soldier_TL_F","O_soldier_M_F","O_Soldier_AA_F","O_Soldier_AT_F","O_Soldier_A_F","O_Soldier_SL_F","O_officer_F","O_sniper_F","O_spotter_F","O_soldier_exp_F","O_engineer_U_F"];	
	...
	_stPool=	["O_Mortar_01_F","O_static_AT_F","O_static_AA_F","O_HMG_01_high_F","O_HMG_01_A_F","O_GMG_01_F"];
...
// EAST CSAT URBAN UNITS 
	if (_faction==5) then {
	_InfPool=	["O_soldierU_F","O_SoldierU_GL_F","O_soldierU_LAT_F","O_soldierU_AR_F","O_soldierU_medic_F","O_soldierU_TL_F","O_soldierU_AT_F","O_soldierU_AA_F","O_SoldierU_SL_F","O_soldierU_M_F"];	
	_ArmPool=	["O_APC_Tracked_02_AA_F","O_APC_Tracked_02_cannon_F","O_APC_Wheeled_02_rcws_F","O_MBT_02_cannon_F"];
	_MotPool=	["O_Truck_03_covered_F","O_Truck_03_transport_F","O_MRAP_02_F","O_MRAP_02_gmg_F","O_MRAP_02_hmg_F","O_Truck_03_medical_F"];
	_ACHPool=	["O_Heli_Attack_02_black_F","O_Heli_Attack_02_F","O_Plane_CAS_02_F"];
	_CHPool=	["O_Heli_Light_02_F","O_Heli_Light_02_unarmed_F"];
	_uavPool=	["O_UAV_01_F","O_UAV_02_CAS_F","O_UGV_01_rcws_F"];
	_stPool=	["O_Mortar_01_F","O_static_AT_F","O_static_AA_F","O_HMG_01_high_F","O_HMG_01_A_F","O_GMG_01_high_F"];
	_shipPool=	["O_Boat_Armed_01_hmg_F","O_Boat_Transport_01_F"];
	_diverPool=	["O_diver_exp_F","O_diver_F","O_diver_TL_F"];
	_crewPool=	["O_crew_F"];
	_heliCrew=	["O_helicrew_F","O_helipilot_F"];
...
// EAST CSAT SPECOPS UNITS 	
	if (_faction==6) then {
	_InfPool=	["O_recon_F","O_recon_LAT_F","O_recon_M_F","O_recon_medic_F","O_recon_TL_F","O_recon_JTAC_F","O_recon_exp_F"];	
	_ArmPool=	["O_APC_Tracked_02_AA_F","O_APC_Tracked_02_cannon_F","O_APC_Wheeled_02_rcws_F","O_MBT_02_cannon_F"];
	_MotPool=	["O_Truck_03_covered_F","O_Truck_03_transport_F","O_MRAP_02_F","O_MRAP_02_gmg_F","O_MRAP_02_hmg_F","O_Truck_03_medical_F"];
	_ACHPool=	["O_Heli_Attack_02_black_F","O_Heli_Attack_02_F","O_Plane_CAS_02_F"];
	_CHPool=	["O_Heli_Light_02_F","O_Heli_Light_02_unarmed_F"];

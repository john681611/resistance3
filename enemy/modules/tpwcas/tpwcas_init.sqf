...
tpwcas_running = true;
	...
	call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_debug.sqf"; //visual debugging

	if !(isDedicated) then 
	{
		call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_client_debug.sqf"; //visual debugging
		call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_visuals.sqf"; //player suppression visuals
	};
	
	call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_decskill.sqf"; //decrease AI skills
	call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_incskill.sqf"; //increase AI skills
	call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_supstate.sqf"; //bdetect callback to assign unit suppression status
	call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_getcover.sqf"; //move suppressed unit into cover
	call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_runforit.sqf"; //civilians will run away from the shooting

	call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_mainloop.sqf"; //main loop
	
	//////////////
	//CALL BDETECT
	////////////// 

	call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_bdetect.sqf"; //bullet detection
...
//	};
	...
	{
		call compileFinal preprocessFileLineNumbers "enemy\modules\tpwcas\tpwcas_los.sqf"; //tpw los main loop
		
		// Run day/night determination
		[] execVM "enemy\modules\tpwcas\tpwcas_los_sunangle.sqf"; //determine day or night

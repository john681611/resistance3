...
class RecruitUnitsDialog {
	...
	onLoad = "[] execVM 'support\modules\bon_recruit_units\build_unitlist.sqf'";
	...
	class controls {
		...
		class Unitlist: HW_RscGUIListBox {
			...
			onLBSelChanged = "";
			onLBDblClick = "execVM 'support\modules\bon_recruit_units\recruit.sqf'";
			rowHeight = 0.025;
		...
		class RecruitButton: HW_RscGUIShortcutButton {
			...
			w = 0.125; h = 0.05;
			text = "Recruit";
			onButtonClick = "execVM 'support\modules\bon_recruit_units\recruit.sqf'";
		};

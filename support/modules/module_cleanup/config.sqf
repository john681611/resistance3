...
pvpfw_cleanup_abandonedFromFaction = []; // Vehicles from these factions will be cleaned up
pvpfw_cleanUp_abandonRadius = 1500; // If no unit is closer than the specified distance, the removal countdown will start
pvpfw_cleanup_abandondTimer = 600; // The vehicle will be removed after the specified time
pvpfw_cleanUp_dontCleanUpAround = ["respawn_west","respawn_east","respawn_civilian","respawn_vehicle_guerrila","supplies_0","supplies_1"]; //do not clean abandoned vehicles around these markers
...
pvpfw_cleanUp_weaponHolderRadius = 700; // The weaponholders cleanup countdown will start if no unit is closer than this
...
pvpfw_cleanUp_ruinRadius = 1000; // Destroyed Buildings will be deleted if no entity is in the specified range around them

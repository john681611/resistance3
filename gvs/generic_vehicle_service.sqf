/*=================================================================================================================
  ...
  Display Information:
  GVS uses RscTitles for the information display. It is very possible that missions you try to integrate GVS into will aslo
...
if (_abort == 0) then
{
    ...
    {
    	["Repair.ogg", 6, 0.05, (_damageToRepair * _per_repair_time), _oVehicle, 15, 1.0, 40, true] spawn Sound_Loop3D;
    ...
    if (_vehicleMagazinesCount > 0 ) then
    {
        _mag = 0;
        {
        	["reload.ogg", 8, 0.02, _per_magazine_time, _oVehicle, 10, 1.0, 25, true] spawn Sound_Loop3D;
	...
	_ovehicle setObjectTextureGlobal [0,"ambience\modules\images\fia_camo.paa"];
	_ovehicle setObjectTextureGlobal [1,"ambience\modules\images\fia_camo.paa"];
	_ovehicle setObjectTextureGlobal [2,"ambience\modules\images\fia_camo.paa"];

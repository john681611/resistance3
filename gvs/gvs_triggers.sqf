...
_veh_per_fuel_time = 1;		//seconds per percent of fuel
_veh_per_repair_time = 3;	//seconds per percent of repair
_veh_per_magazine_time = 3;	//seconds per magazine reload

_hel_maxDistance = 8;
_hel_maxHeight = 4;
_hel_serviceStartDelay = 8;
_hel_per_fuel_time = 1;
_hel_per_repair_time = 3;
_hel_per_magazine_time = 3;

_pla_maxDistance = 8;
_pla_maxHeight = 6;
_pla_serviceStartDelay = 10;
_pla_per_fuel_time = 1;
_pla_per_repair_time = 3;
_pla_per_magazine_time = 3;

_uav_maxDistance = 6;
_uav_maxHeight = 2;
_uav_serviceStartDelay = 8;
_uav_per_fuel_time = 1;
_uav_per_repair_time = 3;
_uav_per_magazine_time = 3;
